    ...
    <div className={styles.page}>
      ...
      <section className={styles.mediaGallerySection}>
        <div className={styles.galleryHeader}>
          ...
          <p className={`${styles.gallerySubtitle} typo-h4`}>ВСЕ НАПРАВЛЕНИЯ</p>
        </div>
      ...
      <section className={styles.hallsSection}>
        ...
        <div className={styles.hallsList}>
          {BANQUET_HALLS.map((hall, index) => {
            const activeIndex = mediaIndexByHall[hall.id] ?? 0
            ...
            return (
              <div
                key={hall.id}
                className={`${styles.hallRow} ${index % 2 === 1 ? styles.hallRowReverse : ''}`}
              >
                <HallCard
                  ...
                  inView
                  onThumbClick={(next) =>
                    setMediaIndexByHall((prev) => ({ ...prev, [hall.id]: next }))
                  }
