...
export const KidsAnimationPage = ({ onNavigate, onBook }: KidsAnimationPageProps) => {
  ...
  return (
    <div className={styles.page}>
      ...
      <section className={styles.section} style={{ marginTop: '106px', maxWidth: '1440px', overflow: 'hidden' }}>
      ...
      <section className={styles.section}>
        <div className={styles.blockStack}>
          ...
          <div className={styles.fullVideo}>
            <img src={videoIcon} alt="Видео" width={70} height={70} style={{ maxWidth: '1440px' }}/>
          </div>
        </div>
      </section>
