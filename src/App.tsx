  ...
  const renderPage = () => {
    switch (activePage) {
      case 'home':
        return (
          <HomePage
            onBook={() => setPopup('booking')}
            onOpenMenu={() => setPopup('menu')}
            onNavigateAbout={() => handleNavigate('about')}
          />
        )
      case 'about':
        return <AboutPage onNavigate={handleNavigate} onBook={() => setPopup('booking')} />
      case 'menu':
        return <MenuPage onNavigate={handleNavigate} />
      case 'banquets':
        return <BanquetsPage onNavigate={handleNavigate} onBook={() => setPopup('booking')} />
      case 'kidsAnimation':
