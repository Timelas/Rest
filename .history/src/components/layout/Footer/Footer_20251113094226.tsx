      ...
      <div className={styles.primary}>
        <div className={styles.columns}>
          ...
          <div>
            ...
            <p className={cn('typo-footer', styles.columnText)}>{contacts.secondaryPhone}</p>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className={styles.list}>
              {contacts.halls.map((hall) => (
                <li key={hall.title} className="typo-footer">{`${hall.title} — ${hall.capacity}`}</li>
              ))}
            </ul>
          </div>
          <div>
            <p className={cn('typo-h5', styles.columnTitle)}>Соцсети</p>
