...
import chefImage from '@/assets/img/shef.png'
...
const GALLERY_IMAGES = [
  ...
  { id: 'gallery-8', src: gallery1, alt: 'Кухня Satrapezo' },
  { id: 'gallery-9', src: gallery2, alt: 'Интерьер Satrapezo' },
  { id: 'gallery-10', src: gallery3, alt: 'Команда ресторана' },
  { id: 'gallery-11', src: gallery4, alt: 'Подача блюд' },
]
  ...
  <div className={styles.page}>
    <section className={styles.section}>
      ...
      <FeatureHighlight
        ...
        description={`Шеф-повар Манжгаладзе Шакро Самсонович за многолетний стаж покорил своими кулинарными шедеврами не мало сердец.
Опыт Шакро Самсоновича насчитывает более, чем 20 лет, а за спиной работа в известных проектах России и Грузии!
Разнообразие и изобилие традиционной грузинской и европейской кухонь в нашем меню основано на аутентичных рецептах, собранных шеф-поваром с разных уголков солнечной Грузии и Европы. Окунитесь в незабываемое гастрономическое путешествие Satrapezo!
Девиз Шакро: «Еда - это музыка для языка. И вы обязательно должны её услышать!»`}
        image={chefImage}
