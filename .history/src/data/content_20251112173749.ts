...
export const HERO_BADGES = [
  { id: 'fire', icon: '🔥', title: 'Скидка 20% в будни с 12 до 16' },
  { id: 'wine', icon: '🍷', title: 'Детская анимация' },
  { id: 'music', icon: '🎼', title: 'Бесплатная парковка' },
  { id: 'family', icon: '👨‍👩‍👧', title: 'Живая музыка по субботам' },
]
